...
<div class="header">
    <h1>汽车4S店售后管理系统</h1>
    <div class="user-info">
        <a href="${pageContext.request.contextPath}/mechanic/profile" style="color:white; text-decoration:none;">欢迎，${sessionScope.user.realName} (技师)</a>
...
<div class="nav">
    ...
    <a href="${pageContext.request.contextPath}/mechanic/orders">工单管理</a>
    <a href="${pageContext.request.contextPath}/mechanic/messages">消息中心</a>
    <a href="${pageContext.request.contextPath}/mechanic/maintenance-reminder">保养提醒</a>
    <a href="${pageContext.request.contextPath}/mechanic/profile" class="active">个人信息</a>
</div>
...
<div class="container">
    <div class="profile-card">
        ...
        <form action="${pageContext.request.contextPath}/mechanic/profile/update" method="post">
            <div class="info-section">
                <h3>可修改信息</h3>
