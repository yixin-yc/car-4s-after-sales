...
<div class="nav">
    ...
    <a href="${pageContext.request.contextPath}/owner/profile" class="active">个人信息</a>
</div>
...
<div class="container">
    <div class="profile-card">
        ...
        <form action="${pageContext.request.contextPath}/owner/profile/update" method="post">
            <div class="info-section">
                <h3>可修改信息</h3>
